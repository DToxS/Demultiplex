...
ConvIlluminaFASTQSequence::ConvIlluminaFASTQSequence(const FASTQSequenceLines& lines, bool parse_seq, bool parse_seq_id_level_1, bool parse_seq_id_level_2) : IlluminaFASTQSequence(lines, parse_seq, parse_seq_id_level_1, parse_seq_id_level_2)
{
    setGroupId();
    setBarcode();
}
...
// parse_seq is defaulted to true for the parsing of IlluminaFASTQSequence.
ConvIlluminaFASTQSequence::ConvIlluminaFASTQSequence(FASTQSequenceLines&& lines, bool parse_seq, bool parse_seq_id_level_1, bool parse_seq_id_level_2) : IlluminaFASTQSequence(std::move(lines), parse_seq, parse_seq_id_level_1, parse_seq_id_level_2)
{
    setGroupId();
    setBarcode();
}
